...
privileged aspect ComentarioDocumentoController_Roo_Controller {
    ...
    public String ComentarioDocumentoController.create(@Valid ComentarioDocumento comentarioDocumento, BindingResult result, Model model) {
        if (result.hasErrors()) {
    ...
    public String ComentarioDocumentoController.createForm(Model model) {
        model.addAttribute("comentarioDocumento", new ComentarioDocumento());
        addDateTimeFormatPatterns(model);
    ...
    public String ComentarioDocumentoController.show(@PathVariable("id") Long id, Model model) {
        addDateTimeFormatPatterns(model);
        model.addAttribute("comentariodocumento", ComentarioDocumento.findComentarioDocumento(id));
        model.addAttribute("itemId", id);
        return "comentariodocumentoes/show";
    }
    
    @RequestMapping(method = RequestMethod.GET)
    public String ComentarioDocumentoController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model model) {
        if (page != null || size != null) {
            int sizeNo = size == null ? 10 : size.intValue();
            model.addAttribute("comentariodocumentoes", ComentarioDocumento.findComentarioDocumentoEntries(page == null ? 0 : (page.intValue() - 1) * sizeNo, sizeNo));
            float nrOfPages = (float) ComentarioDocumento.countComentarioDocumentoes() / sizeNo;
            model.addAttribute("maxPages", (int) ((nrOfPages > (int) nrOfPages || nrOfPages == 0.0) ? nrOfPages + 1 : nrOfPages));
        } else {
            model.addAttribute("comentariodocumentoes", ComentarioDocumento.findAllComentarioDocumentoes());
        }
        addDateTimeFormatPatterns(model);
    ...
    public String ComentarioDocumentoController.update(@Valid ComentarioDocumento comentarioDocumento, BindingResult result, Model model) {
        if (result.hasErrors()) {
            model.addAttribute("comentarioDocumento", comentarioDocumento);
            addDateTimeFormatPatterns(model);
    ...
    public String ComentarioDocumentoController.updateForm(@PathVariable("id") Long id, Model model) {
        model.addAttribute("comentarioDocumento", ComentarioDocumento.findComentarioDocumento(id));
        addDateTimeFormatPatterns(model);
        return "comentariodocumentoes/update";
    }
    ...
    public String ComentarioDocumentoController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model model) {
        ComentarioDocumento.findComentarioDocumento(id).remove();
        model.addAttribute("page", (page == null) ? "1" : page.toString());
        model.addAttribute("size", (size == null) ? "10" : size.toString());
        return "redirect:/comentariodocumentoes?page=" + ((page == null) ? "1" : page.toString()) + "&size=" + ((size == null) ? "10" : size.toString());
    }
    ...
    Converter<ComentarioDocumento, String> ComentarioDocumentoController.getComentarioDocumentoConverter() {
        return new Converter<ComentarioDocumento, String>() {
            public String convert(ComentarioDocumento comentarioDocumento) {
                return new StringBuilder().append(comentarioDocumento.getDsComentario()).append(" ").append(comentarioDocumento.getDtInclusao()).toString();
            }
        };
    }
    ...
    void ComentarioDocumentoController.addDateTimeFormatPatterns(Model model) {
        model.addAttribute("comentarioDocumento_dtinclusao_date_format", DateTimeFormat.patternForStyle("S-", LocaleContextHolder.getLocale()));
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.GET, headers = "Accept=application/json")
    @ResponseBody
    public String ComentarioDocumentoController.showJson(@PathVariable("id") Long id) {
        return ComentarioDocumento.findComentarioDocumento(id).toJson();
    }
    
    @RequestMapping(method = RequestMethod.POST, headers = "Accept=application/json")
    public ResponseEntity<String> ComentarioDocumentoController.createFromJson(@RequestBody String json) {
        ComentarioDocumento.fromJsonToComentarioDocumento(json).persist();
        return new ResponseEntity<String>("ComentarioDocumento created", HttpStatus.CREATED);
    }
    
    @RequestMapping(headers = "Accept=application/json")
    @ResponseBody
    public String ComentarioDocumentoController.listJson() {
        return ComentarioDocumento.toJsonArray(ComentarioDocumento.findAllComentarioDocumentoes());
    }
    
    @RequestMapping(value = "/jsonArray", method = RequestMethod.POST, headers = "Accept=application/json")
    public ResponseEntity<String> ComentarioDocumentoController.createFromJsonArray(@RequestBody String json) {
        for (ComentarioDocumento comentariodocumento: ComentarioDocumento.fromJsonArrayToComentarioDocumentoes(json)) {
            comentariodocumento.persist();
        }
        return new ResponseEntity<String>("ComentarioDocumento created", HttpStatus.CREATED);
    }
