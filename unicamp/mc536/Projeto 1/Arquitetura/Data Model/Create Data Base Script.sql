...
CREATE TABLE `documento` (
  ...
  `ds_documento` text NOT NULL,
  `ds_email_autor` varchar(100) default NULL,
  `ds_info_maquina` varchar(255) default NULL,
  `dt_criacao` datetime NOT NULL default '0000-00-00 00:00:00',
  `dt_inclusao` datetime NOT NULL default '0000-00-00 00:00:00',
  `nm_arquivo` varchar(255) NOT NULL default '',
  `nm_autor` varchar(255) default NULL,
  ...
  `id_pais` bigint(20) NOT NULL default '0',
  `id_programa` bigint(20) default NULL,
  `id_rede_trabalho` bigint(20) default NULL,
  `id_usuario_autor` bigint(20) default NULL,
  `id_usuario_responsavel` bigint(20) default NULL,
  `tipo_documento` bigint(20) NOT NULL default '0',
  PRIMARY KEY  (`id`),
  ...
  KEY `FK383D52B4EDD17EC2` (`tipo_documento`),
  KEY `FK383D52B44535FA45` (`id_programa`),
  KEY `FK383D52B42ACACB64` (`id_rede_trabalho`),
  KEY `FK383D52B4C21BD8C1` (`id_pais`),
  CONSTRAINT `FK383D52B4C21BD8C1` FOREIGN KEY (`id_pais`) REFERENCES `pais` (`id`),
  CONSTRAINT `FK383D52B410F27F95` FOREIGN KEY (`id_usuario_autor`) REFERENCES `usuario` (`id`),
  CONSTRAINT `FK383D52B425A527EA` FOREIGN KEY (`id_idioma_documento`) REFERENCES `idioma` (`id`),
  CONSTRAINT `FK383D52B42ACACB64` FOREIGN KEY (`id_rede_trabalho`) REFERENCES `rede_trabalho` (`id`),
  CONSTRAINT `FK383D52B44535FA45` FOREIGN KEY (`id_programa`) REFERENCES `programa` (`id`),
  CONSTRAINT `FK383D52B4603D80F2` FOREIGN KEY (`id_usuario_responsavel`) REFERENCES `usuario` (`id`),
  CONSTRAINT `FK383D52B4EDD17EC2` FOREIGN KEY (`tipo_documento`) REFERENCES `tipo_documento` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `documento_referencia_pais`
--

DROP TABLE IF EXISTS `documento_referencia_pais`;
CREATE TABLE `documento_referencia_pais` (
  `id` bigint(20) NOT NULL auto_increment,
  `version` int(11) default NULL,
  `id_documento` bigint(20) NOT NULL default '0',
  `id_pais` bigint(20) NOT NULL default '0',
  PRIMARY KEY  (`id`),
  KEY `FK131C387D4580C13D` (`id_documento`),
  KEY `FK131C387DC21BD8C1` (`id_pais`),
  CONSTRAINT `FK131C387DC21BD8C1` FOREIGN KEY (`id_pais`) REFERENCES `pais` (`id`),
  CONSTRAINT `FK131C387D4580C13D` FOREIGN KEY (`id_documento`) REFERENCES `documento` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Table structure for table `documento_vinculo`
--

DROP TABLE IF EXISTS `documento_vinculo`;
CREATE TABLE `documento_vinculo` (
  `id` bigint(20) NOT NULL auto_increment,
  `ds_vinculo` varchar(255) NOT NULL default '',
  `dt_inclusao` datetime NOT NULL default '0000-00-00 00:00:00',
  `tp_referencia_documento` int(11) NOT NULL default '0',
  `version` int(11) default NULL,
  `id_documento` bigint(20) NOT NULL default '0',
  `id_usuario` bigint(20) NOT NULL default '0',
  PRIMARY KEY  (`id`),
  KEY `FK7F020D854580C13D` (`id_documento`),
  KEY `FK7F020D85F63EF371` (`id_usuario`),
  CONSTRAINT `FK7F020D85F63EF371` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`),
  CONSTRAINT `FK7F020D854580C13D` FOREIGN KEY (`id_documento`) REFERENCES `documento` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `programa_usuario` (
  ...
  `id_usuario` bigint(20) NOT NULL default '0',
  PRIMARY KEY  (`id`),
  KEY `FK27039F4CF63EF371` (`id_usuario`),
  KEY `FK27039F4C87A1391C` (`id_rede_trabalho`),
  CONSTRAINT `FK27039F4C87A1391C` FOREIGN KEY (`id_rede_trabalho`) REFERENCES `programa` (`id`),
  CONSTRAINT `FK27039F4CF63EF371` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `usuario` (
  `id` bigint(20) NOT NULL auto_increment,
  `ds_instituicao` varchar(255) default NULL,
  `ds_login` varchar(10) NOT NULL default '',
  `ds_senha` varchar(10) NOT NULL default '',
  `dt_inclusao` datetime NOT NULL default '0000-00-00 00:00:00',
  `email` varchar(255) NOT NULL default '',
  ...
  `tp_usuario` int(11) NOT NULL default '0',
  `version` int(11) default NULL,
  `id_idioma_nativo` bigint(20) NOT NULL default '0',
  PRIMARY KEY  (`id`),
  KEY `FKF814F32EF7696823` (`id_idioma_nativo`),
  CONSTRAINT `FKF814F32EF7696823` FOREIGN KEY (`id_idioma_nativo`) REFERENCES `idioma` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `usuario_idioma` (
  ...
  `id_usuario` bigint(20) NOT NULL default '0',
  PRIMARY KEY  (`id`),
  KEY `FK4BC92B06F63EF371` (`id_usuario`),
  KEY `FK4BC92B0692F95DF5` (`id_idioma`),
  CONSTRAINT `FK4BC92B0692F95DF5` FOREIGN KEY (`id_idioma`) REFERENCES `idioma` (`id`),
  CONSTRAINT `FK4BC92B06F63EF371` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
