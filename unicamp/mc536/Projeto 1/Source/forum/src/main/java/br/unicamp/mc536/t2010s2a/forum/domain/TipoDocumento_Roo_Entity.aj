...
privileged aspect TipoDocumento_Roo_Entity {
    ...
    public void TipoDocumento.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            TipoDocumento attached = this.entityManager.find(this.getClass(), this.id);
    ...
    public static long TipoDocumento.countTipoDocumentoes() {
        return ((Number) entityManager().createQuery("select count(o) from TipoDocumento o").getSingleResult()).longValue();
    }
    
    @SuppressWarnings("unchecked")
    public static List<TipoDocumento> TipoDocumento.findAllTipoDocumentoes() {
        return entityManager().createQuery("select o from TipoDocumento o").getResultList();
    }
    ...
    public static List<TipoDocumento> TipoDocumento.findTipoDocumentoEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("select o from TipoDocumento o").setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }
