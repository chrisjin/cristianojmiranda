...
privileged aspect DocumentoVinculo_Roo_Entity {
    ...
    public void DocumentoVinculo.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            DocumentoVinculo attached = this.entityManager.find(this.getClass(), this.id);
    ...
    public static long DocumentoVinculo.countDocumentoVinculoes() {
        return ((Number) entityManager().createQuery("select count(o) from DocumentoVinculo o").getSingleResult()).longValue();
    }
    
    @SuppressWarnings("unchecked")
    public static List<DocumentoVinculo> DocumentoVinculo.findAllDocumentoVinculoes() {
        return entityManager().createQuery("select o from DocumentoVinculo o").getResultList();
    }
    ...
    @SuppressWarnings("unchecked")
    public static List<DocumentoVinculo> DocumentoVinculo.findDocumentoVinculoEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("select o from DocumentoVinculo o").setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }
