...
privileged aspect ComentarioDocumento_Roo_Entity {
    ...
    public void ComentarioDocumento.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            ComentarioDocumento attached = this.entityManager.find(this.getClass(), this.id);
    ...
    public static long ComentarioDocumento.countComentarioDocumentoes() {
        return ((Number) entityManager().createQuery("select count(o) from ComentarioDocumento o").getSingleResult()).longValue();
    }
    
    @SuppressWarnings("unchecked")
    public static List<ComentarioDocumento> ComentarioDocumento.findAllComentarioDocumentoes() {
        return entityManager().createQuery("select o from ComentarioDocumento o").getResultList();
    }
    
    public static ComentarioDocumento ComentarioDocumento.findComentarioDocumento(Long id) {
        if (id == null) return null;
        return entityManager().find(ComentarioDocumento.class, id);
    }
    
    @SuppressWarnings("unchecked")
    public static List<ComentarioDocumento> ComentarioDocumento.findComentarioDocumentoEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("select o from ComentarioDocumento o").setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }
