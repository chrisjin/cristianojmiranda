...
privileged aspect Documento_Roo_Entity {
    ...
    public void Documento.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            Documento attached = this.entityManager.find(this.getClass(), this.id);
    ...
    public static long Documento.countDocumentoes() {
        return ((Number) entityManager().createQuery("select count(o) from Documento o").getSingleResult()).longValue();
    }
